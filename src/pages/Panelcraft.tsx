    ...
    <AppLayout>
      <div className="flex flex-col h-[calc(100vh-0px)] lg:h-screen">
        ...
        <div className="flex-1 flex overflow-hidden">
          <div className="hidden md:block w-60 overflow-y-auto border-r border-border bg-card/40">
            <div className="px-3 py-2 font-mono text-[10px] uppercase tracking-widest text-muted-foreground sticky top-0 bg-card/60 backdrop-blur border-b border-border">
          ...
          <div className="hidden xl:block w-80 overflow-y-auto border-l border-border p-4 space-y-4 bg-card/40">
            <div>
